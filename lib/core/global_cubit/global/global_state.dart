...
class FontSizeSavedState extends GlobalState {}

class FontSizeSaveErrorState extends GlobalState {
  final String message;
  FontSizeSaveErrorState(this.message);
}
...
class ChangeLanguageState extends GlobalState {}

class ChangeFontSizeState extends GlobalState {}
